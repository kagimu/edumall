...
<div class="page-header">
    ...
    <div class="page-rightheader ml-auto d-lg-flex d-none">
        <a class="btn btn-success" href="{{ route('create.labs') }}"> Add Computer Lab product</a>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title">All Computer Lab Products</div>
            </div>
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered text-nowrap" id="example1">
                        ...
                        <tbody>
                            @foreach($computerlabs as $opportunity)
                            <tr>
