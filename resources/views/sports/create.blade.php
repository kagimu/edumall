...
<div class="col-lg-12">>
    <div class="card">
        ...
        <div class="pull-right">
            <a class="btn btn-primary" href="{{ route('index.sports') }}"> Back</a>
        </div>
        @if(session('status'))
        ...
        @endif
        <div class="card-body">
            <form action="{{ route('store.sports') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select name="category" id="category" class="form-control">
                        ...
                        <option value="balls">outdoor_games</option>
                        <option value="jerseys">jerseys</option>
                        <option value="board_games">board_games</option>
                        <option value="indoor_games">indoor_games</option>
                    </select>
                    @error('category')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    @enderror
